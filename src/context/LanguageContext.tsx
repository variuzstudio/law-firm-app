...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'login.aiDesc': 'Sign in with your Google account to access all AI features automatically — no setup required.',
  ...
  id: {
    ...
    'login.orContinue': 'atau',
    'login.aiPowered': 'Platform Berbasis AI',
    'login.aiDesc': 'Masuk dengan akun Google Anda untuk mengakses semua fitur AI secara otomatis — tanpa perlu pengaturan.',
