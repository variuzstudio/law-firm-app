      ...
      <div className="flex items-center justify-between h-14 px-3 lg:px-6">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <div ref={langRef} className="relative">
            ...
            {langOpen && (
              <div className="absolute right-6 top-full mt-6 w-40 glass-card p-1.5 shadow-elegant-lg z-50" style={{ backdropFilter: 'none', WebkitBackdropFilter: 'none' }}>
                <button
          ...
          <div ref={notifRef} className="relative">
            ...
            {notifOpen && (
              <div className="absolute right-6 top-full mt-6 w-80 glass-card shadow-elegant-lg overflow-hidden z-50" style={{ backdropFilter: 'none', WebkitBackdropFilter: 'none' }}>
